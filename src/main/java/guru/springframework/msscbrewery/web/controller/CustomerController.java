...
public class CustomerController {
    ...
    @PostMapping
    public ResponseEntity postBCustomer(@Valid @RequestBody CustomerDto customerDto){
    ...
    public void handleUpdate(@NotNull @PathVariable("customerId") UUID customerId, @Valid @RequestBody CustomerDto customerDto){
